...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.mdcb1 = MDCB(16, 16,  kernel_sizes=kernel_sizes)
        self.mdcb2 = MDCB(32, 32, kernel_sizes=kernel_sizes)
        self.mdcb3 = MDCB(64, 64,  kernel_sizes=kernel_sizes)
        self.mdcb4 = MDCB(128, 128, kernel_sizes=kernel_sizes)
        self.mdcb5 = MDCB(256, 256, kernel_sizes=kernel_sizes)

        self.reg5 = RegHead(128)
        self.reg4 = RegHead(64)
        self.reg3 = RegHead(32)
        self.reg2 = RegHead(16)
        self.reg1 = RegHead(8)


        self.upsample_trilin = nn.Upsample(scale_factor=2, mode='trilinear', align_corners=True)

        self.conva1 = Conv3dReLU(512, 256)
        self.conva2 = Conv3dReLU(256, 128)
        self.conva3 = Convup(256, 128)
        
        self.convb1 = Conv3dReLU(384, 128)
        self.convb2 = Conv3dReLU(128, 64)
        self.convb3 = Convup(128, 64)
        
        self.convc1 = Conv3dReLU(192, 64)
        self.convc2 = Conv3dReLU(64, 32)
        self.convc3 = Convup(64, 32)

        self.convd1 = Conv3dReLU(96, 32)
        self.convd2 = Conv3dReLU(32, 16)
        self.convd3 = Convup(32, 16)

        self.conve1 = Conv3dReLU(48, 16)
        self.conve2 = Conv3dReLU(16, 8)
        inshape = [160,192,160]
